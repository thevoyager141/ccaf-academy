  ...
  { id:"p6s1", ch:"①", title:"고객지원 해결 에이전트", scenario:"s1",
    steps:[
      ...
      {type:"quiz", kind:"PRACTICE · 시나리오 실전", h:"S1-1 — Two issues, one gap",
       ...
       hint:`두 요청의 성격이 달라 — 하나는 정책 안, 하나는 정책에 조항이 없는 요청. 각각의 처방이 뭐였지?`,
       explain:{good:`멀티 컨선 분해(1.4) + 정책 공백 에스컬레이션(5.2)의 결합. 할 수 있는 건 하고, 정책에 조항이 없는 건 지어내지 말고 넘겨 — 구조화 요약과 함께.`,
